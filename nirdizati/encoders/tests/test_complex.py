...
class TestComplex(TestCase):
    ...
    def test_has_columns(self):
        df = complex.encode_trace(self.frame, additional_columns=self.attributes)
    ...
    def test_prefix_length(self):
        df = complex.encode_trace(self.frame, additional_columns=self.attributes, prefix_length=3)
